...
function getStyles(props, context) {
  ...
  return {
    ...
    check: {
      ...
      transition: _transitions2.default.easeOut('150ms', 'opacity', '0ms') + ', ' + _transitions2.default.easeOut('0ms', 'transform', '450ms'),
...
var Checkbox = function (_Component) {
  ...
  (0, _createClass3.default)(Checkbox, [{
    ...
    value: function render() {
      // console.log('value: function render() {, this.props', this.props);
